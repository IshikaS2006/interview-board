...
|---|---|
| ![Room join screen](screenshots/room-join.png) | ![Whiteboard canvas](screenshots/whiteboard.png) |
...
|---|---|
| ![Read-only code panel](screenshots/code-editor.png) | ![Participant switcher dropdown](screenshots/participant-switch.png) |
